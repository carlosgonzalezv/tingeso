    ...
    public class BookingService {
        ...
        private final PackTourService packTourService;
        ...
        public BookingService(BookingRepository bookingRepository,
                              ...
                              PackTourService packTourService,
                              BookingProperties bookingProps) {
            this.bookingRepository = bookingRepository;
            this.packTourRepository = packTourRepository;
            this.userRepository = userRepository;
            this.packTourService = packTourService;
        ...
        private BookingEntity createBookingBase(UserEntity user, PackTourEntity pack, BookingRequestDTO request) {
            ...
            BookingCalculationResult calculation = calculateDetailedTotal(user, pack.getPrice(), request.getPassengerCount());
        ...
        public BookingEntity updateBookingStatus(Long id, String status) {
            ...
            if ("CONFIRMADA".equals(newStatus) && !checkPaymentProof(id)) {
            ...
            if ("CANCELADA".equals(newStatus) && !"CANCELADA".equals(oldStatus)) {
                packTourService.addSlot(booking.getPackTour().getId(), passengerCount);
        ...
        public BookingResponseDTO getBookingDetailsForDisplay(Long bookingId) {
            ...
            int passengerCount = 1 + (booking.getCompanions() != null ? booking.getCompanions().size() : 0);
            BookingCalculationResult calc = calculateDetailedTotal(booking.getUsers(), booking.getPackTour().getPrice(), passengerCount);
